(function() {
  define([], function(require) {
    var Edge, Graph, Vertex, animLoop, arrayOf, attractionStrength, centerX, centerY, ctx, dampeningFactor, drawCircle, drawLine, glMatrix, graph, iterate, makeGraph, numFrames, radius, render, repulsionStrength, type;

    glMatrix = require('gl-matrix/dist/gl-matrix');
    console.log('there');
